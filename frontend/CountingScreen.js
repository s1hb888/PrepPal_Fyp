...
const styles = StyleSheet.create({
  ...
  heading:{fontSize:34, fontWeight:"bold", color:"#FFB6C1", textShadowColor:"#FFC1CC", textShadowOffset:{width:2,height:2}, textShadowRadius:4},
  numberSection:{alignItems:"center", marginVertical:10},
  numeral:{fontSize:100, fontWeight:"bold", color:"#FFD54F", textShadowColor:"#FFE680", textShadowOffset:{width:3,height:3}, textShadowRadius:6},
  word:{fontSize:32, fontWeight:"600", color:"#FFB6C1", textShadowColor:"#FFC1CC", textShadowOffset:{width:2,height:2}, textShadowRadius:4},
  ...
  speakerButton:{backgroundColor:"#FFD54F", padding:15, borderRadius:50, elevation:5},
