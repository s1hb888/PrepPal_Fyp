...
const Home = ({ navigation }) => {
  ...
  progress={
    quizSummary.totalQuizzes > 0
      ? quizSummary.passed / quizSummary.totalQuizzes
      : 0
  }
  size={130}
  thickness={10}
  ...
  formatText={() =>
    quizSummary.totalQuizzes > 0
      ? `${Math.round((quizSummary.passed / quizSummary.totalQuizzes) * 100)}%`
      : '0%'
  }
  color="#EF3349"
  unfilledColor="#fff"
...
/>
  ...
  <View style={styles.statItem}>
    ...
    <Text style={styles.statLabel}>
      <Text style={styles.statBold}>{quizSummary.totalQuizzes}</Text> Attempted
    </Text>
  </View>
  ...
  <View style={styles.statItem}>
    ...
    <Text style={styles.statLabel}>
      <Text style={styles.statBold}>{quizSummary.failed}</Text> Failed
          ...
          <TouchableOpacity onPress={() => navigation.navigate('Performance')} style={styles.progressButton}>
