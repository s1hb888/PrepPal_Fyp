...
const cardWidth = windowWidth * 0.9; // single column width
...
const styles = StyleSheet.create({
  ...
  topHeader: { borderBottomLeftRadius: 20, borderBottomRightRadius: 20, paddingVertical: 40, paddingHorizontal: 20, alignItems: 'flex-start', overflow: 'hidden' },
  whiteCurve: { backgroundColor: '#fff', borderTopLeftRadius: 40, borderTopRightRadius: 40, marginTop: -20, paddingHorizontal: 16, paddingTop: 10, paddingBottom: 8, elevation: 5, shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 8 },
  ...
  sectionTitle: { fontSize: 18, fontWeight: 'bold', marginBottom: 5, marginTop: 4, color: 'black' },
  videoGradientBorder: { borderRadius: 14, padding: 2, marginBottom: 16 },
  videoContainer: { borderRadius: 12, overflow: 'hidden', backgroundColor: '#fff', borderWidth: 2, borderColor: 'rgb(160,240,220)' },
  watchMoreButton: { flexDirection: 'row', padding: 10, borderBottomLeftRadius: 10, borderBottomRightRadius: 10, alignItems: 'center', justifyContent: 'center' },
  watchMoreText: { color: '#000', fontWeight: '600' },
  cardWrapper: { width: cardWidth, height: 120, borderRadius: 20, overflow: 'hidden', elevation: 5, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 6, marginBottom: 10 },
  card: { flex: 1, padding: 14, justifyContent: 'flex-start', alignItems: 'flex-start' },
  iconBackground: { backgroundColor: 'white', borderRadius: 10, width: 38, height: 38, justifyContent: 'center', alignItems: 'center', marginBottom: 8 },
  cardTitle: { marginTop: 4, color: '#000', fontWeight: 'bold', fontSize: 14, textAlign: 'left' },
  cardSubtitle: { color: '#000', fontSize: 12, textAlign: 'left', opacity: 0.6 },
