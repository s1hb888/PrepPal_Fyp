...
const styles = StyleSheet.create({
  ...
  score: { fontSize: 20, fontWeight: "bold", color: "#007AFF", marginBottom: 10, textAlign: "center" },
  quizTitle: { fontSize: 22, fontWeight: "bold", color: "#333", marginBottom: 20, textAlign: "center" },
  questionCard: { backgroundColor: "#FFF", borderRadius: 12, padding: 15, alignItems: "center", shadowColor: "#000", shadowOpacity: 0.1, shadowOffset: { width: 0, height: 2 }, elevation: 3 },
  questionText: { fontSize: 18, color: "#000", marginBottom: 10, textAlign: "center" },
  image: { width: "100%", height: 180, resizeMode: "contain", borderRadius: 10, marginBottom: 10 },
  recordBtn: { marginTop: 30, backgroundColor: "#007AFF", paddingVertical: 14, borderRadius: 10, alignItems: "center" },
  stopBtn: { marginTop: 30, backgroundColor: "#FF3B30", paddingVertical: 14, borderRadius: 10, alignItems: "center" },
